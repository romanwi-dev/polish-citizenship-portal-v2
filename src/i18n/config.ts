...
const resources = {
  ...
  de: {
    translation: {
      ...
      timelineProcess: {
        badge: 'Unser Prozess',
        title: 'Polnische Staatsbürgerschafts-Zeitplan',
  ...
  fr: {
    translation: {
      ...
      timelineProcess: {
        ...
        title: 'Calendrier de Citoyenneté Polonaise',
  ...
  ru: {
    translation: {
      ...
      timelineProcess: {
        badge: 'Наш процес',
        title: 'Графік отримання польського громадянства',
        subtitle: 'Чесний і реалістичний шлях із 15 етапів від першого контакту до паспорта ЄС - як працює кожен етап із прозорими цінами та реальними термінами',
        ...
        foundationBuilding: 'Створення основи',
        stage1: 'ПЕРШІ КРОКИ',
        stage1Desc: 'Перший контакт, тест на громадянство, родинне дерево, перевірка відповідності та дзвінок про відповідність',
        stage1Duration: 'Тиждень 1',
        stage1Action: 'Первинне налаштування та оплата',
        stage2: 'УМОВИ ТА ЦІНИ',
        stage2Desc: 'Первинна оцінка, повна інформація про процес із цінами, підтвердження клієнта та список документів',
        stage2Duration: 'Тиждень 1-2',
        stage2Action: 'Первинне налаштування та оплата',
        stage3: 'АВАНС І АКАУНТ',
        stage3Desc: 'Обробка авансового платежу та відкриття облікового запису клієнтського порталу',
        stage3Duration: 'Тиждень 2',
        stage3Action: 'Первинне налаштування та оплата',
        stage4: 'ДЕТАЛІ ТА ДОВІРЕНОСТІ',
        stage4Desc: 'Клієнт надає основні дані, підготовка довіреностей та підписані документи через FedEx',
        stage4Duration: 'Тиждень 2-3',
        stage4Action: 'Деталі та заява',
        stage5: 'ДАНІ ТА ЗАЯВА',
        stage5Desc: 'Заповнення майстер-форми, генерація документів за допомогою ШІ та офіційна подача заяви на громадянство',
        ...
        stage8: 'ПЕРЕКЛАДИ',
        stage8Desc: 'Сервіс ШІ-перекладу, сертифікація присяжного перекладача та нагляд агента з перекладів',
        stage8Duration: 'Тиждень 8-16',
        stage8Action: 'Документація та переклад',
        stage9: 'ПОДАЧА ДОКУМЕНТІВ',
        stage9Desc: 'Подача місцевих та польських документів до первинної відповіді, якщо можливо',
        stage9Duration: 'Тиждень 12-20',
        stage9Action: 'Документація та переклад',
        stage10: 'ЦИВІЛЬНІ АКТИ',
        stage10Desc: 'Заяви на польські свідоцтва про народження/шлюб, подачі та нагляд виділеного агента',
        stage10Duration: 'Тиждень 16-24',
        stage10Action: 'Державна обробка',
        stage11: 'ПЕРВИННА ВІДПОВІДЬ',
        stage11Desc: 'Отримання державного листа, оцінка вимог, продовження терміну та очікування додаткових доказів',
        stage11Duration: 'Місяць 10-18',
        stage11Action: 'Державна обробка',
        stage12: 'СХЕМИ PUSH',
        stage12Desc: 'Пояснення схем PUSH, NUDGE, SIT-DOWN, платежі та реалізація',
        stage12Duration: 'Місяць 12-24',
        stage12Action: 'Державна обробка',
        stage13: 'РІШЕННЯ ПРО ГРОМАДЯНСТВО',
        stage13Desc: 'Отримано рішення про підтвердження польського громадянства, надіслано клієнту електронною поштою та додано на портал',
        stage13Duration: 'Місяць 18-36',
        stage13Action: 'Заключні етапи',
        stage14: 'ПОЛЬСЬКИЙ ПАСПОРТ',
        stage14Desc: 'Підготовка документів, остаточний платіж, доставка FedEx, призначення зустрічі в консульстві',
        stage14Duration: 'Місяць 20-40',
        stage14Action: 'Заключні етапи',
        stage15: 'РОЗШИРЕНІ ПОСЛУГИ',
        stage15Desc: 'Розширені сімейні юридичні послуги доступні після успішного підтвердження громадянства',
        stage15Duration: 'Постійно',
        stage15Action: 'Заключні етапи',
        detailedInfoTitle: 'Детальна інформація',
        detailedInfoDesc: 'Повний зміст графіка, детальні вимоги та специфіка процесу доступні зареєстрованим користувачам в їхньому обліковому записі порталу.',
        detailedInfoSignup: 'Зареєструйтеся для доступу до детального покрокового керівництва',
        detailedInfoCta: 'На портал',
        detailedInfoNote: 'Примітка: Ці терміни є оцінками, заснованими на понад 200 успішних справах. Ваша фактична справа може відрізнятися залежно від складності та термінів державної обробки.',
