...
export const FAMILY_TREE_PDF_MAP: Record<string, string> = {
  ...
  'applicant_spouse_maiden_name': 'spouse_maiden_name',
  'spouse_date_of_birth': 'spouse_dob',
  'spouse_place_of_birth': 'spouse_pob',
  'spouse_date_of_emigration': 'spouse_date_of_emigration',
  'spouse_date_of_naturalization': 'spouse_date_of_naturalization',
  ...
  'minor_4_full_name': 'child_4_first_name',
  'minor_4_date_of_birth': 'child_4_dob',
  'minor_4_place_of_birth': 'child_4_pob',
  'minor_5_full_name': 'child_5_first_name',
  'minor_5_date_of_birth': 'child_5_dob',
  'minor_5_place_of_birth': 'child_5_pob',
  
  // Father
  'father_full_name': 'father_first_name',
  'father_maiden_name': 'father_maiden_name',
  ...
  'pgf_maiden_name': 'pgf_maiden_name',
  ...
  'mgf_maiden_name': 'mgf_maiden_name',
  ...
  // Great-Grandparents - Paternal Side (PGGF/PGGM)
  'pggf_full_name': 'pggf_first_name',
  'pggf_maiden_name': 'pggf_maiden_name',
  ...
  // Great-Grandparents - Maternal Side (MGGF/MGGM)
  'mggf_full_name': 'mggf_first_name',
  'mggf_maiden_name': 'mggf_maiden_name',
