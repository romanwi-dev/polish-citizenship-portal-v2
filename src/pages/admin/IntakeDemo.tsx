        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <Input
              ...
              className="h-16 bg-cyan-100/45 dark:bg-cyan-900/45 border border-cyan-300/30 dark:border-cyan-500/30 hover:border-transparent focus:border-transparent transition-all duration-300"
              style={{
                boxShadow: "0 0 30px rgba(103,232,249,0.25)",
                transition: "all 0.3s ease"
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow = "0 0 50px rgba(103,232,249,0.4)";
                e.currentTarget.style.transform = "translateY(-2px)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.boxShadow = "0 0 30px rgba(103,232,249,0.25)";
                e.currentTarget.style.transform = "translateY(0)";
              }}
              onFocus={(e) => {
                e.currentTarget.style.boxShadow = "0 0 60px rgba(103,232,249,0.5)";
                e.currentTarget.style.transform = "translateY(-2px)";
              }}
              onBlur={(e) => {
                e.currentTarget.style.boxShadow = "0 0 30px rgba(103,232,249,0.25)";
          ...
          <div className="flex items-center gap-4">
            ...
            <Input
              ...
              className="h-16 bg-red-50/45 dark:bg-red-950/45 border border-red-400/30 dark:border-red-600/30 hover:border-transparent focus:border-transparent transition-all duration-300"
              style={{
          ...
          <div className="flex items-center gap-4">
            ...
            <Input
              ...
              className="h-16 bg-white/45 dark:bg-slate-700/45 border border-slate-100/30 dark:border-slate-400/30 hover:border-transparent focus:border-transparent transition-all duration-300"
              style={{
                boxShadow: "0 0 30px rgba(241,245,249,0.25)",
                transition: "all 0.3s ease"
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow = "0 0 50px rgba(241,245,249,0.4)";
                e.currentTarget.style.transform = "translateY(-2px)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.boxShadow = "0 0 30px rgba(241,245,249,0.25)";
                e.currentTarget.style.transform = "translateY(0)";
              }}
              onFocus={(e) => {
                e.currentTarget.style.boxShadow = "0 0 60px rgba(241,245,249,0.5)";
                e.currentTarget.style.transform = "translateY(-2px)";
              }}
              onBlur={(e) => {
                e.currentTarget.style.boxShadow = "0 0 30px rgba(241,245,249,0.25)";
          ...
          <div className="flex items-center gap-4">
            ...
            <Input
              ...
              className="h-16 bg-gray-200/45 dark:bg-gray-700/45 border border-gray-300/30 dark:border-gray-500/30 hover:border-transparent focus:border-transparent transition-all duration-300"
              style={{
          ...
          <div className="flex items-center gap-4">
            ...
            <Input
              ...
              className="h-16 bg-emerald-50/45 dark:bg-emerald-900/45 border border-emerald-300/30 dark:border-emerald-500/30 hover:border-transparent focus:border-transparent transition-all duration-300"
              style={{
                boxShadow: "0 0 30px rgba(110,231,183,0.25)",
                transition: "all 0.3s ease"
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow = "0 0 50px rgba(110,231,183,0.4)";
                e.currentTarget.style.transform = "translateY(-2px)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.boxShadow = "0 0 30px rgba(110,231,183,0.25)";
                e.currentTarget.style.transform = "translateY(0)";
              }}
              onFocus={(e) => {
                e.currentTarget.style.boxShadow = "0 0 60px rgba(110,231,183,0.5)";
                e.currentTarget.style.transform = "translateY(-2px)";
              }}
              onBlur={(e) => {
                e.currentTarget.style.boxShadow = "0 0 30px rgba(110,231,183,0.25)";
