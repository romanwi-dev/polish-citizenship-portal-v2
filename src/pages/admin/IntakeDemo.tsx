        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <Input
              ...
              className="h-16 bg-cyan-50/45 dark:bg-cyan-950/45 border border-cyan-400/30 dark:border-cyan-600/30 hover:border-transparent focus:border-transparent transition-all duration-300"
              style={{
          ...
          <div className="flex items-center gap-4">
            ...
            <Input
              ...
              className="h-16 bg-slate-50/45 dark:bg-slate-950/45 border border-slate-400/30 dark:border-slate-600/30 hover:border-transparent focus:border-transparent transition-all duration-300"
              style={{
