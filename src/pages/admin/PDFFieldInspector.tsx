...
import {
  ...
  CITIZENSHIP_PDF_MAP,
  FAMILY_TREE_PDF_MAP,
  UMIEJSCOWIENIE_PDF_MAP,
  UZUPELNIENIE_PDF_MAP,
} from '@/config/pdfMappings';
...
const TEMPLATES = [
  ...
  { id: 'citizenship', name: 'Citizenship Application', mapping: CITIZENSHIP_PDF_MAP },
  { id: 'family-tree', name: 'Family Tree', mapping: FAMILY_TREE_PDF_MAP },
  { id: 'umiejscowienie', name: 'Civil Registry Entry', mapping: UMIEJSCOWIENIE_PDF_MAP },
  { id: 'uzupelnienie', name: 'Civil Registry Supplement', mapping: UZUPELNIENIE_PDF_MAP },
];
