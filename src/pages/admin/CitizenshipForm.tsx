      ...
      <div className="container mx-auto py-12 px-4 md:px-6 lg:px-8 relative z-10 max-w-7xl">
        ...
        >
          ...
          >
            ...
            <Button onClick={() => navigate(`/admin/cases/${caseId}/poa`)} variant="outline"
            ...
            {/* Current form - Citizenship Application - HIGHLIGHTED */}
            <Button variant="default"
              className="text-sm md:text-base lg:text-lg font-bold px-4 md:px-6 lg:px-8 h-10 md:h-12 lg:h-14 rounded-lg bg-gradient-to-r from-primary to-secondary shadow-glow hover-glow backdrop-blur-md border border-white/30 min-w-[200px] md:min-w-[240px] lg:min-w-[280px] whitespace-nowrap flex-shrink-0">
              <span className="text-white">Citizenship Application</span>
            </Button>
