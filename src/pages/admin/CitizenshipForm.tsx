              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                ...
                >
                  ...
                  <CardDescription className="text-xl md:text-2xl mt-4 text-muted-foreground leading-relaxed">
                    Wniosek o potwierdzenie posiadania obywatelstwa polskiego (OBY)
                  </CardDescription>
                </motion.div>
                <motion.div
                  initial={{ x: 20, opacity: 0 }}
          ...
          >
            <Card className="glass-card border-primary/20">
              ...
              <CardContent className="p-6 md:p-10 space-y-10">
                {renderFieldGroup([
                  { name: "applicant_last_name", label: "Nazwisko / Last Name" },
                  { name: "applicant_maiden_name", label: "Nazwisko rodowe / Maiden Name" },
                  { name: "applicant_first_name", label: "Imię/imiona / First Name(s)" },
            ...
            <Card className="glass-card border-primary/20">
              ...
              <CardContent className="p-6 md:p-10 space-y-10">
                ...
                <div className="space-y-6">
                  ...
                  {renderFieldGroup([
                    { name: "mother_last_name", label: "Nazwisko / Last Name" },
                    { name: "mother_maiden_name", label: "Nazwisko rodowe / Maiden Name" },
                    { name: "mother_first_name", label: "Imię/imiona / First Name(s)" },
                ...
                <div className="space-y-6">
                  ...
                  {renderFieldGroup([
                    { name: "father_last_name", label: "Nazwisko / Last Name" },
                    { name: "father_first_name", label: "Imię/imiona / First Name(s)" },
              ...
              <CardContent className="p-6 md:p-10 space-y-10">
                ...
                <div className="p-6 border-2 border-border/50 rounded-xl bg-card/30 backdrop-blur space-y-6">
                  ...
                  {renderFieldGroup([
                    ...
                    { name: "mgm_first_name", label: "Imię/imiona / First Name(s)" },
                ...
                <div className="p-6 border-2 border-border/50 rounded-xl bg-card/30 backdrop-blur space-y-6">
                  ...
                  {renderFieldGroup([
                    ...
                    { name: "pgm_first_name", label: "Imię/imiona / First Name(s)" },
