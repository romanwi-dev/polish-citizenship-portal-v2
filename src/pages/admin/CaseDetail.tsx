...
import { GrantPortalAccessSection } from "@/components/admin/GrantPortalAccessSection";
import { 
  CheckSquare, 
  AlertCircle, 
  ArrowLeft,
          ...
          <TabsContent value="forms" className="space-y-6">
            <Tabs defaultValue={defaultFormSection} onValueChange={(value) => setSearchParams({ tab: "forms", section: value })}>
              ...
              <TabsContent value="poa" className="mt-6">
                <div className="flex justify-center items-center mt-8 mb-6 md:mt-10 md:mb-8">
                  <Button
