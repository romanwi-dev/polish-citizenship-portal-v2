        ...
        <div className="absolute inset-0 w-full h-full backface-hidden glass-card p-6 rounded-lg hover-glow">
          ...
          <div className="space-y-3 mt-auto">
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <span className="relative z-10 bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent flex items-center justify-center gap-1.5 w-full">
