                  ...
                  >
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        className="absolute inset-0 w-full h-[440px] glass-card p-8 rounded-lg hover-glow group flex flex-col"
                        style={{
                      ...
                      {/* Back */}
                      <div 
                        className="absolute inset-0 w-full h-[440px] glass-card p-8 rounded-lg hover-glow flex flex-col"
                        style={{
                          backfaceVisibility: 'hidden',
                          WebkitBackfaceVisibility: 'hidden',
