      ...
      <Tabs defaultValue="cards" className="space-y-4">
        <div className="w-full overflow-x-auto scrollbar-hide">
          <TabsList className="flex gap-1 w-full justify-between h-auto p-0 bg-transparent border-0">
            ...
            <TabsTrigger value="agent" className="flex-1 h-14 bg-red-500/20 border-2 border-red-500/30 hover:bg-red-500/30 hover:shadow-[0_0_30px_rgba(239,68,68,0.3)] transition-all data-[state=active]:bg-red-950/40 data-[state=active]:border-red-950 data-[state=active]:shadow-[0_0_40px_rgba(127,29,29,0.5)] text-white/100 data-[state=active]:text-white/50 font-bold text-lg">
              Civil Acts Agent
            </TabsTrigger>
            <TabsTrigger value="payment" className="flex-1 h-14 bg-red-500/20 border-2 border-red-500/30 hover:bg-red-500/30 hover:shadow-[0_0_30px_rgba(239,68,68,0.3)] transition-all data-[state=active]:bg-red-950/40 data-[state=active]:border-red-950 data-[state=active]:shadow-[0_0_40px_rgba(127,29,29,0.5)] text-white/100 data-[state=active]:text-white/50 font-bold text-lg">
              Payment Tracker
            </TabsTrigger>
          </TabsList>
        </div>
