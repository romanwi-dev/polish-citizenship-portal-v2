      ...
      <Tabs defaultValue="cards" className="space-y-4">
        <div className="w-full overflow-x-auto scrollbar-hide">
          <TabsList className="inline-flex h-auto p-0 w-max bg-transparent border-0 gap-1">
            ...
            <TabsTrigger value="agent" className="px-8 py-3 text-base whitespace-nowrap h-14 font-medium w-[200px] rounded-none first:rounded-l-lg last:rounded-r-lg bg-red-700 hover:bg-red-800 border-red-700 text-white">
              Civil Acts Agent
            </TabsTrigger>
            <TabsTrigger value="payment" className="px-8 py-3 text-base whitespace-nowrap h-14 font-medium w-[200px] rounded-none first:rounded-l-lg last:rounded-r-lg bg-red-700 hover:bg-red-800 border-red-700 text-white">
              Payment Tracker
            </TabsTrigger>
          </TabsList>
        </div>
