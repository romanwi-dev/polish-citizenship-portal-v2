...
export const SectionLayout = ({
  ...
  return (
    <section id={id} className={`relative py-16 overflow-hidden overflow-x-hidden ${className}`}>
      <div className="container relative z-10 px-4 mx-auto">
        {/* Header: Badge + Title + Subtitle */}
        <div className="max-w-4xl mx-auto text-center mb-12 animate-fade-in pt-8 space-y-6">
          {/* Badge */}
          {badge && (
