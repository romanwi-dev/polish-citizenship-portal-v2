        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card mb-16 border border-[#7C1328]/30">
              <Brain className="w-4 h-4 text-[#D94565]" />
              <span className="text-sm font-medium bg-gradient-to-r from-[#7C1328] to-[#D94565] bg-clip-text text-transparent">AI-Powered Analysis</span>
            </div>
