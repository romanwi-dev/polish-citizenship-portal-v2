      ...
      <div className="container relative z-10 px-4 mx-auto">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="mb-16">
              <p className="text-xl text-muted-foreground max-w-6xl text-justify mb-8">
              ...
              <p className="text-lg text-muted-foreground max-w-6xl text-justify mb-8">
              ...
              <p className="text-lg text-muted-foreground max-w-6xl text-justify">
