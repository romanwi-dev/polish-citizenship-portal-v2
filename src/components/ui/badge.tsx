...
const badgeVariants = cva(
  "inline-flex items-center rounded border px-3 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 min-w-[70px] justify-center",
  {
    variants: {
      variant: {
