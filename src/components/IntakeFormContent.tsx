  ...
  <>
    ...
    <div className="px-4 py-6 md:p-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 md:items-start">
        ...
        <DateField name="applicant_dob" label="Date of birth" value={formData?.applicant_dob} onChange={(value) => handleInputChange("applicant_dob", value)} delay={0.45} colorScheme="applicant" isLargeFonts={isLargeFonts} />
      </div>
      ...
      {formData?.applicant_is_married && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 md:items-start">
          ...
          <div>
            <DateField name="date_of_marriage" label="Date of marriage" value={formData?.date_of_marriage} onChange={(value) => handleInputChange("date_of_marriage", value)} delay={0.5} colorScheme="applicant" isLargeFonts={isLargeFonts} />
          </div>
        </div>
      )}
    </div>
