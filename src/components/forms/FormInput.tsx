  ...
  return (
    <div className="w-full">
      <Input 
        ...
        className={cn(
          "h-16 md:h-20 border-2 hover:border-transparent focus:border-transparent transition-all duration-300 backdrop-blur font-normal font-input-work w-full max-w-full",
          scheme.bg,
          scheme.border,
