...
const colorSchemes = {
  children: {
    ...
    border: 'border-cyan-300/5 dark:border-cyan-500/5',
  ...
  applicant: {
    ...
    border: 'border-blue-200/5 dark:border-blue-800/5',
  ...
  parents: {
    ...
    border: 'border-teal-400/5 dark:border-teal-600/5',
  ...
  grandparents: {
    ...
    border: 'border-red-400/5 dark:border-red-600/5',
  ...
  ggp: {
    ...
    border: 'border-gray-200/5 dark:border-gray-600/5',
  ...
  poa: {
    ...
    border: 'border-gray-300/5 dark:border-gray-500/5',
  ...
  citizenship: {
    ...
    border: 'border-blue-300/5 dark:border-blue-500/5',
  ...
  'civil-reg': {
    ...
    border: 'border-emerald-300/5 dark:border-emerald-500/5',
