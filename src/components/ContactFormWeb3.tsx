              ...
              >
                ...
                >
                  ...
                  <Button 
                    type="submit" 
                    size="lg"
                    className="text-lg md:text-2xl font-bold px-8 py-4 md:px-20 md:py-6 h-auto min-h-[48px] rounded-lg bg-blue-50/45 dark:bg-blue-950/40 hover:bg-blue-50/60 dark:hover:bg-blue-950/60 border-2 hover-glow focus:shadow-lg transition-all backdrop-blur w-full"
                  >
