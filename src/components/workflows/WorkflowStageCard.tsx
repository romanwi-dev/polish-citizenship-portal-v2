  ...
  return (
    ...
    >
      ...
      >
        ...
        <div 
          className={cn(
            "absolute inset-0 w-full h-[440px] glass-card p-6 rounded-lg transition-all duration-300 flex flex-col",
            isCompleted 
        ...
        {/* Back Side */}
        <div 
          className="absolute inset-0 w-full h-[440px] glass-card p-8 rounded-lg flex flex-col"
          style={{
            backfaceVisibility: 'hidden',
            WebkitBackfaceVisibility: 'hidden',
