...
export const AIDocumentWorkflow = ({ caseId }: { caseId: string }) => {
  ...
  const workflowSteps: AIWorkflowStep[] = [
    {
      ...
      stage: 'upload',
      agent: 'human',
      backDetails: t('workflow.stage1BackDetails')
    },
    {
      number: "02",
      ...
      stage: 'intake',
      agent: 'ai',
      backDetails: t('workflow.stage2BackDetails')
    },
    {
      number: "03",
      ...
      stage: 'ai_classify',
      agent: 'ai',
      backDetails: t('workflow.stage3BackDetails')
    },
    {
      number: "04",
      ...
      stage: 'hac_classify',
      agent: 'human',
      backDetails: t('workflow.stage4BackDetails')
    },
    {
      number: "05",
      ...
      stage: 'ocr',
      agent: 'ai',
      backDetails: t('workflow.stage5BackDetails')
    },
    {
      number: "06",
      ...
      stage: 'ocr_quality',
      agent: 'both',
      backDetails: t('workflow.stage6BackDetails')
    },
    {
      number: "07",
      ...
      agent: 'ai',
      backDetails: t('workflow.stage7BackDetails')
    },
    {
      number: "08",
      ...
      stage: 'translation',
      agent: 'both',
      backDetails: t('workflow.stage8BackDetails')
    },
    {
      number: "09",
      ...
      agent: 'human',
      backDetails: t('workflow.stage9BackDetails')
    },
    {
      number: "10",
      ...
      agent: 'ai',
      backDetails: t('workflow.stage10BackDetails')
    },
    {
      number: "11",
      ...
      agent: 'ai',
      backDetails: t('workflow.stage11BackDetails')
    },
    {
      number: "12",
      ...
      stage: 'hac_forms',
      agent: 'human',
      backDetails: t('workflow.stage12BackDetails')
    },
    {
      number: "13",
      ...
      stage: 'ai_verify',
      agent: 'ai',
      backDetails: t('workflow.stage13BackDetails')
    },
    {
      number: "14",
      ...
      stage: 'hac_verify',
      agent: 'human',
      backDetails: t('workflow.stage14BackDetails')
    },
    {
      number: "15",
      ...
      stage: 'final_audit',
      agent: 'both',
      backDetails: t('workflow.stage15BackDetails')
    },
    {
      number: "16",
      ...
      agent: 'ai',
      backDetails: t('workflow.stage16BackDetails')
    }
  ];
          ...
          return (
            ...
            >
              <div className={`md:flex ${isLeft ? 'md:flex-row' : 'md:flex-row-reverse'} items-center gap-8`}>
                    ...
                    >
                        ...
                        >
                          <div className="flex flex-col gap-3 h-full items-center text-center justify-center">
                            ...
                            <motion.div 
                              className="flex items-center justify-between w-full mt-auto mb-6"
                              initial={{ opacity: 0, y: 10 }}
                              animate={{ opacity: 1, y: 0 }}
                ...
                <motion.div 
                  className="hidden md:flex md:w-2/12 flex-shrink-0 justify-center relative z-10 items-center"
                  initial={{ opacity: 0, x: isLeft ? -50 : 50 }}
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true, margin: "-50px" }}
                  transition={{ duration: 0.6, delay: index * 0.1 }}
