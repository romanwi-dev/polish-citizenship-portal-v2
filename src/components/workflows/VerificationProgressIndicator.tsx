...
export function VerificationProgressIndicator({ 
  ...
  const estimatedTotal = 150; // 2.5 minutes in seconds (edge function timeout limit)
    ...
    <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-secondary/5">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="text-xs text-muted-foreground bg-secondary/20 p-2 rounded">
          💡 <span className="font-medium">Tip:</span> Comprehensive analysis takes 1-2 minutes. 
          Lovable AI (Gemini) is analyzing security, architecture, performance, and reliability.
        </div>
      </CardContent>
    </Card>
  );
