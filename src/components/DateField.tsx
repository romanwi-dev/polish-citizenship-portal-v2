...
const colorSchemes = {
  children: {
    ...
    border: 'border-cyan-300/10 dark:border-cyan-500/10',
  ...
  applicant: {
    ...
    border: 'border-blue-200/10 dark:border-blue-800/10',
  ...
  parents: {
    ...
    border: 'border-teal-400/10 dark:border-teal-600/10',
  ...
  grandparents: {
    ...
    border: 'border-red-400/10 dark:border-red-600/10',
  ...
  ggp: {
    ...
    border: 'border-gray-200/10 dark:border-gray-600/10',
  ...
  poa: {
    ...
    border: 'border-gray-300/10 dark:border-gray-500/10',
  ...
  citizenship: {
    ...
    border: 'border-blue-300/10 dark:border-blue-500/10',
  ...
  'civil-reg': {
    ...
    border: 'border-emerald-300/10 dark:border-emerald-500/10',
