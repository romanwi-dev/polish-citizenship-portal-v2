      ...
      <Tabs defaultValue="cards" className="space-y-4">
        <div className="w-full overflow-x-auto scrollbar-hide">
          <TabsList className="inline-flex h-auto p-0 w-max bg-transparent border-0 gap-1">
            ...
            <TabsTrigger value="family" className="px-8 py-3 text-base whitespace-nowrap h-14 font-medium w-[200px] rounded-none first:rounded-l-lg last:rounded-r-lg bg-red-500 hover:bg-red-600 border-red-500">
              Family Legal
            </TabsTrigger>
            <TabsTrigger value="procurement" className="px-8 py-3 text-base whitespace-nowrap h-14 font-medium w-[200px] rounded-none first:rounded-l-lg last:rounded-r-lg bg-red-500 hover:bg-red-600 border-red-500">
              Document Procurement
            </TabsTrigger>
            <TabsTrigger value="heritage" className="px-8 py-3 text-base whitespace-nowrap h-14 font-medium w-[200px] rounded-none first:rounded-l-lg last:rounded-r-lg bg-red-500 hover:bg-red-600 border-red-500">
              Heritage Research
            </TabsTrigger>
            <TabsTrigger value="relocation" className="px-8 py-3 text-base whitespace-nowrap h-14 font-medium w-[200px] rounded-none first:rounded-l-lg last:rounded-r-lg bg-red-500 hover:bg-red-600 border-red-500">
              Relocation
            </TabsTrigger>
            <TabsTrigger value="analytics" className="px-8 py-3 text-base whitespace-nowrap h-14 font-medium w-[200px] rounded-none first:rounded-l-lg last:rounded-r-lg bg-red-500 hover:bg-red-600 border-red-500">
              Analytics
            </TabsTrigger>
          </TabsList>
        </div>
