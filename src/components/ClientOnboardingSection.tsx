            ...
            >
              ...
              <div className={`flex flex-col md:${isLeft ? 'flex-row' : 'flex-row-reverse'} gap-4 md:gap-12 items-center`}>
                ...
                >
                  {/* Front Side */}
                  <div
                    className="absolute inset-0 w-full h-[480px] glass-card p-8 rounded-lg hover-glow group transition-transform duration-300 hover:scale-[1.03] hover:-translate-y-1 flex flex-col justify-center items-center"
                    style={{
                  ...
                  {/* Back Side */}
                  <div 
                    className="absolute inset-0 w-full h-[480px] glass-card p-6 rounded-lg hover-glow flex flex-col"
                    style={{
                      backfaceVisibility: 'hidden',
                      WebkitBackfaceVisibility: 'hidden',
