  ...
  return <section className="relative min-h-[60vh] md:min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-4 pt-32 pb-20 mx-auto">
        <div className="max-w-4xl mx-auto text-center mb-12 md:mb-20">
          ...
          <p className="text-lg md:text-xl lg:text-2xl font-light mb-12 md:mb-16 leading-relaxed max-w-full md:max-w-[95%] animate-fade-in mx-auto px-4 md:px-0 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in max-w-6xl mx-auto" style={{ animationDelay: '200ms' }}>
            ...
            >
              <div className="w-full h-full flex flex-col items-center justify-center">
                ...
                <p className="text-base md:text-lg font-medium text-white">Years of Experience</p>
              </div>
            </div>
            ...
            >
              <div className="w-full h-full flex flex-col items-center justify-center">
                <h3 className="text-3xl md:text-4xl font-bold text-white mb-2">&gt;20,000</h3>
                <p className="text-base md:text-lg font-medium text-white">Cases Processed</p>
              </div>
            </div>
            ...
            >
              <div className="w-full h-full flex flex-col items-center justify-center">
                ...
                <p className="text-base md:text-lg font-medium text-white">Success Rate</p>
              </div>
            </div>
          </div>
        </div>
