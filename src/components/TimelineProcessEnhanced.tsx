        ...
        <div className="relative max-w-5xl mx-auto mt-24">
          ...
          {timelineSteps.map((step, index) => {
            ...
            <motion.div 
              ...
              className={`relative mb-32 md:mb-28 flex flex-col md:flex-row items-center gap-8 ${!isLeft ? 'md:flex-row-reverse' : ''}`}
            >
              ...
              animationDelay: `${(index + 1) * 100}ms`
                ...
                transform: flippedCards[step.number] ? 'rotateY(180deg)' : 'rotateY(0deg)'
                    ...
                    {/* Front Side */}
                    <div className="absolute inset-0 w-full h-[520px] glass-card p-5 rounded-lg hover-glow group transition-transform duration-300 hover:scale-[1.02] flex flex-col justify-center items-center" style={{
                  ...
                  WebkitBackfaceVisibility: 'hidden'
                    ...
                    {/* Back Side */}
                    <div className="absolute inset-0 w-full h-[520px] glass-card p-5 rounded-lg hover-glow flex flex-col" style={{
                  backfaceVisibility: 'hidden',
                  WebkitBackfaceVisibility: 'hidden',
