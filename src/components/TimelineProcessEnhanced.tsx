            ...
            >
              ...
              animationDelay: `${(index + 1) * 100}ms`
                ...
                transform: flippedCards[step.number] ? 'rotateY(180deg)' : 'rotateY(0deg)'
                    ...
                    {/* Front Side */}
                    <div className="absolute inset-0 w-full h-[600px] glass-card p-5 rounded-lg hover-glow group transition-transform duration-300 hover:scale-[1.02] flex flex-col justify-center items-center" style={{
                  ...
                  WebkitBackfaceVisibility: 'hidden'
                    ...
                    {/* Back Side */}
                    <div className="absolute inset-0 w-full h-[600px] glass-card p-5 rounded-lg hover-glow flex flex-col" style={{
                  backfaceVisibility: 'hidden',
                  WebkitBackfaceVisibility: 'hidden',
