  ...
  return (
    ...
    >
      ...
      {!showOtherInput ? (
        ...
        >
          <SelectTrigger className={cn("h-16 md:h-20 border-2 focus:shadow-lg transition-all backdrop-blur text-xs [&>span]:text-xs", scheme.bg, scheme.border)}>
        ...
        <div className="space-y-2">
          <Input
            ...
            placeholder=""
            className={cn("h-16 md:h-20 border-2 focus:shadow-lg transition-all backdrop-blur uppercase text-xs", scheme.bg, scheme.border)}
          />
          <button
            type="button"
            onClick={() => {
