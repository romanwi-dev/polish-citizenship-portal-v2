...
export function FormButtonsRow({ 
  ...
  return (
    <div className="flex flex-row gap-3 mb-8 overflow-x-auto scrollbar-hide relative z-[100]">
      {/* Action Buttons */}
      <div className="flex gap-3 flex-shrink-0 relative z-[100]">
        <Button
          onClick={onSave}
          disabled={isSaving}
          className="h-10 md:h-12 lg:h-14 px-4 md:px-6 lg:px-8 text-sm md:text-base lg:text-lg font-bold bg-white/5 hover:bg-white/10 shadow-glow hover-glow backdrop-blur-md border border-white/30 group relative overflow-hidden opacity-50 z-[100]"
        >
