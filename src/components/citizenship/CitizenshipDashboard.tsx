      ...
      <Tabs defaultValue="cards" className="space-y-4">
        <div className="w-full overflow-x-auto scrollbar-hide">
          <TabsList className="flex gap-1 w-full justify-between h-auto p-0 bg-transparent border-0">
            ...
            <TabsTrigger value="wsc" className="flex-1 h-14 bg-red-500/20 text-white font-bold text-lg border-2 border-red-500/30 hover:bg-red-500/30 hover:shadow-[0_0_30px_rgba(239,68,68,0.3)] transition-all data-[state=active]:bg-red-500/30 data-[state=active]:shadow-[0_0_30px_rgba(239,68,68,0.3)]">
              WSC Letters
            </TabsTrigger>
            <TabsTrigger value="push" className="flex-1 h-14 bg-red-500/20 text-white font-bold text-lg border-2 border-red-500/30 hover:bg-red-500/30 hover:shadow-[0_0_30px_rgba(239,68,68,0.3)] transition-all data-[state=active]:bg-red-500/30 data-[state=active]:shadow-[0_0_30px_rgba(239,68,68,0.3)]">
              Push Schemes
            </TabsTrigger>
